...
class Pagination
{
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        if (preg_match('~&sort=[a-z]+~', $currentURI, $matches))
        {
        	$currentURI = preg_replace('~&sort=[a-z]+~', '', $currentURI);
                return
 		   '<li class="page-item">
    		  <a class="page-link" href="' . $currentURI . $this->index . $page . $matches[0] . '">' . $text . '</a>
  		    </li>';
  		}
